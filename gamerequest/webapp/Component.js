...
sap.ui.define([
	...
	"sap/ui/Device",
	"de/tit/demo/gamerequest/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("de.tit.demo.gamerequest.Component", {
        ...
        setTaskModels: function () {
            ...
            if(this.getComponentData() && this.getComponentData().startupParameters.taskModel) {
                // set the task model
